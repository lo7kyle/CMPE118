...
uint8_t InitSubHSMGoBeacon2(void) {
    ES_Event returnEvent;

    CurrentState = InitPSubState;
    returnEvent = RunSubHSMGoBeacon2(INIT_EVENT);
...
ES_Event RunSubHSMGoBeacon2(ES_Event ThisEvent) {
                    ...
                    case ES_ENTRY:
                     ...
                     case BUMPED:
                        ...
                        if (ThisEvent.EventParam == 0x1) {
                            ...
                            nextState = TURN_10_RIGHT_BACK;
                            makeTransition = TRUE;
                        } else if (ThisEvent.EventParam == 0x4 || ThisEvent.EventParam == 0xE) {
    ...
    if (makeTransition == TRUE) { // making a state transition, send EXIT and ENTRY
        ...
        RunSubHSMGoBeacon2(EXIT_EVENT); // <- rename to your own Run function
        CurrentState = nextState;
        RunSubHSMGoBeacon2(ENTRY_EVENT); // <- rename to your own Run function
    }
