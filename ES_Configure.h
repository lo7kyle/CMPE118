...
//#define EVENT_CHECK_LIST  CheckLightLevel
#define EVENT_CHECK_LIST  CheckBumps, CheckLightLevel, CheckTrackWire, CheckBeaconDetector
...
#define TURN_TIMER_LEFT 3
#define TURN_TIMER_RIGHT 4
